...
export const CONTEST_GAMES: GameDefinition[] = [
  {
    type: "question",
    label: "Вопрос дня",
    description: "Один открытый вопрос всем гостям. Ответы копятся в ленте и идут на live-экран.",
  ...
  },
  {
    type: "poll",
    label: "Опрос",
    description: "Голосование с вариантами. Баллы получают все, кто проголосовал.",
    ...
    defaultOptions: ["Медленный танец", "Что-то заводное", "Живая музыка"],
  },
  {
    type: "guess_guest",
    label: "Угадай гостя",
    description: "Факт об одном из гостей — команда угадывает, о ком речь. Есть правильный ответ.",
    defaultPrompt: "Кто из гостей объехал автостопом половину страны?",
    icon: UserSearch,
    input: "choice",
    defaultPoints: 15,
    defaultRequiresApproval: false,
    ...
    defaultOptions: ["Алина", "Тимур", "Марина", "Игорь"],
  },
  {
    type: "millionaire",
    label: "Миллионер",
    ...
    allowsMultipleEntries: false,
    optionsLabel: "Варианты ответа",
    defaultOptions: ["Вариант A", "Вариант B", "Вариант C", "Вариант D"],
  },
  {
    type: "photo_challenge",
    label: "Фото-челлендж",
    description: "Задание снять конкретный кадр. Ведущий подтверждает фото и начисляет баллы.",
    defaultPrompt: "Сделайте общее фото команды с кем-то из организаторов",
    icon: Camera,
    input: "photo",
    defaultPoints: 25,
  ...
  },
  {
    ...
    description: "Команда крутит колесо и получает случайное задание из списка.",
    defaultPrompt: "Крутите колесо и выполняйте задание всей командой",
    icon: Gift,
    input: "task",
    defaultPoints: 20,
    defaultRequiresApproval: true,
    ...
    defaultOptions: [
      "Спойте припев песни, которая играла на первом танце",
      "Соберите автографы трёх гостей с других столов",
      "Придумайте и покажите девиз своей команды",
      "Сделайте общее фото в прыжке",
    ],
  },
  {
    type: "secret_mission",
    label: "Тайная миссия",
    description: "Каждой команде достаётся своя миссия. Остальные о ней не знают.",
  ...
  },
  {
    type: "bingo",
    label: "Бинго",
    description: "Карточка активностей. Команда отмечает выполненные клетки, ведущий подтверждает.",
  ...
  },
  {
    ...
    description: "Пожелание, которое организатор откроет и прочитает позже.",
  ...
  },
  {
    ...
    description: "Гости выбирают лучшее фото вечера. Баллы получает команда проголосовавшего.",
    defaultPrompt: "Выберите лучшее фото вечера",
    icon: ThumbsUp,
    input: "vote",
    defaultPoints: 5,
    defaultRequiresApproval: false,
  ...
  },
  {
    type: "team_battle",
    label: "Битва команд",
    description: "Офлайн-конкурс в зале. Баллы командам ведущий начисляет вручную.",
    defaultPrompt: "Конкурс в зале — баллы начисляет ведущий",
    icon: Swords,
    input: "host",
    defaultPoints: 30,
    defaultRequiresApproval: false,
