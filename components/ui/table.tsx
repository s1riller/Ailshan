...
/*
 * Таблица — строки на линиях, без рамок и теней. Заголовки набраны капителью,
 * как надзаголовки секций: они подписывают колонку, а не спорят с данными.
 */
...
const TableHead = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <th
      ref={ref}
      className={cn(
        "h-10 px-3 text-left align-middle text-[11px] font-medium uppercase tracking-[0.12em] text-muted-foreground sm:px-4",
        className,
      )}
      {...props}
    />
