...
/* Карточка — граница в одну линию, без тени: тень остаётся только у того, что парит */
...
const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn("font-serif text-2xl font-semibold leading-none tracking-normal", className)} {...props} />
  ),
);
